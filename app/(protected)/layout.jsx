      ...
      <SidebarProvider defaultOpen={sidebarState === "true"}>
        <BreadcrumbProvider>
          ...
          <SidebarInset className={"flex flex-col overflow-x-hidden"}>
            <header className="flex h-14 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 justify-between border-b">
