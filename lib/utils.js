...
export function formatTimeDifference(startTime, endTime) {
  ...
  try {
    // Parse the date strings - they should be in ISO format
    ...
    // Use the existing formatFractionalHoursAuto function with milliseconds
...
export function isProcessing(status) {
  return [PROCESS_STATUS.PROCESSING].includes(status);
}
