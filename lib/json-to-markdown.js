...
function extractCitationFromGrounding(grounding) {
...
function extractCitation(valueObj) {
  return extractCitationFromGrounding(valueObj?.grounding);
}

function extractCitationFromRow(rowObj) {
  return extractCitationFromGrounding(rowObj?.grounding);
}
